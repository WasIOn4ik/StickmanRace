	...
	public class PaymentsYG : MonoBehaviour
	{
		...
		public void UpdateCatalog()
		{
			...
			else
			{
				...
				{
					StartCoroutine(UpdateIconsCoroutine());
				}*/
			}
		}/*

		private IEnumerator UpdateIconsCoroutine()
		{
			while (!StoreItemProvider.IsInitialized())
			{
				Debug.Log("Waiting");
				yield return null;
			}
		...
		private void UpdateIcons()
		{
			...
			{
				var image = group.transform.GetChild(i).Find("Photo").GetChild(0).GetComponent<RawImage>();
				image.texture = StoreItemProvider.Icons[YandexGame.PaymentsData.id[i]];
				image.enabled = true;
			}
		}*/
